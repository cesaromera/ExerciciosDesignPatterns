...
implements Map<K, K>, Cloneable, Serializable
{
			...
			throws IllegalArgumentException, NullPointerException
	{
		...
		if(matrix == null)
		{
			throw new NullPointerException("A matriz eh nula");
		}

		if(matrix.length != 2)
		{
			throw new IllegalArgumentException("A matriz nao tem duas linhas");
		}

		if(matrix[0].length != matrix[1].length)
		{
			throw new IllegalArgumentException("As linhas de comprimento diferente");
		}
